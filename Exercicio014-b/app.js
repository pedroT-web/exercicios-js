...
//  Função para gerar um número aleatório tendo o limite de 150 que são a quantidade de pokemons
// Math.random - Gera um numero entre 0 e 1 mas sem utilizar o 1, mas trás em formato decimal
// Math.floor - Arredonda os numeros de decimal para inteiro
// Math.random() * (max-min + 1)) + min - utilizado para gerar um numero aleatório fazendo um cálculo aleatorio
